...
var BugFastErrorBoundary = class extends react.Component {
  constructor(props) {
    super(props);
    this.resetError = () => {
  ...
  componentDidCatch(error, errorInfo) {
    ...
    if (instance) {
      instance.handleAdapterError(error, "react", errorInfo.componentStack ?? void 0);
    }
    ...
    if (this.state.hasError && this.state.error) {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx("h2", { style: { margin: "0 0 10px", color: "#cc0000" }, children: "Something went wrong" }),
            /* @__PURE__ */ jsxRuntime.jsx("p", { style: { margin: "0 0 10px", color: "#666" }, children: this.state.error.message }),
...
function withBugFastErrorBoundary(WrappedComponent, errorBoundaryProps) {
  const displayName = WrappedComponent.displayName || WrappedComponent.name || "Component";
  const ComponentWithErrorBoundary = (props) => /* @__PURE__ */ jsxRuntime.jsx(BugFastErrorBoundary, { ...errorBoundaryProps, children: /* @__PURE__ */ jsxRuntime.jsx(WrappedComponent, { ...props }) });
  ComponentWithErrorBoundary.displayName = `withBugFastErrorBoundary(${displayName})`;
  return ComponentWithErrorBoundary;
}

exports.BugFastErrorBoundary = BugFastErrorBoundary;
exports.withBugFastErrorBoundary = withBugFastErrorBoundary;
