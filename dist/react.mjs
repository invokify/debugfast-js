...
var BugFastErrorBoundary = class extends Component {
  constructor(props) {
    super(props);
    this.resetError = () => {
    ...
    if (this.state.hasError && this.state.error) {
      ...
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("h2", { style: { margin: "0 0 10px", color: "#cc0000" }, children: "Something went wrong" }),
            /* @__PURE__ */ jsx("p", { style: { margin: "0 0 10px", color: "#666" }, children: this.state.error.message }),
            /* @__PURE__ */ jsx(
              "button",
              {
...
function withBugFastErrorBoundary(WrappedComponent, errorBoundaryProps) {
  ...
  const ComponentWithErrorBoundary = (props) => /* @__PURE__ */ jsx(BugFastErrorBoundary, { ...errorBoundaryProps, children: /* @__PURE__ */ jsx(WrappedComponent, { ...props }) });
  ComponentWithErrorBoundary.displayName = `withBugFastErrorBoundary(${displayName})`;
  return ComponentWithErrorBoundary;
}

export { BugFastErrorBoundary, withBugFastErrorBoundary };
